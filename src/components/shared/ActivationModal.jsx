      ...
      <DialogContent>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded p-4 space-y-2">
            <p className="text-sm font-medium text-blue-900"> 💳 To have Full access to all the features of PetroX send  the sum of <span className="font-semibold">#{monetizationInfo.price}</span> to the account details below  </p> <br/>  <span className="font-semibold">{monetizationInfo.payment_account}</span>
